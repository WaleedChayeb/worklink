    ...
    <div class="container">
        ...
        @if(isset($invoice->data))
            <div class="row invoice row-printable d-flex justify-content-center align-items-center">
                <div class="col-md-10 invoice-content">
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <tr>
                                                    <td class="text-center"
                                                        colspan="2">{{$invoice->transaction->job->title}}
                                                    </td>
                                                    <td class="text-center">
                                                ...
                                                <tr>
                                                    ...
                                                    <th class="text-center">
                                                        {{\App\Providers\SettingsServiceProvider::getWebsiteFormattedAmount($invoice->data['taxesTotalAmount'])}}
                                                    </th>
                                                </tr>
