<trix-toolbar id="{{$id}}" class="trix-toolbar my-2 mb-3">
    <div class="trix-button-row d-flex flex-start">

      <span class="trix-button-group trix-button-group--text-tools border-right" data-trix-button-group="text-tools">
        <button type="button" class="trix-button trix-button--icon trix-button--icon-bold trix-active" data-trix-attribute="bold" data-trix-key="b" title="Bold" tabindex="-1" data-trix-active="">Bold</button>
