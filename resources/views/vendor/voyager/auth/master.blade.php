...
<head>
    ...
    @if($admin_favicon == '')
        <link rel="shortcut icon" href="{{ asset(getSetting('admin.icon_image')) }}" type="image/x-icon">
    @else
            ...
            <div class="clearfix">
                <div class="col-sm-12 col-md-10 col-md-offset-2">
                    <div class="logo-title-container">
                        ...
                        @if($admin_logo_img == '')
                            <img class="img-responsive pull-left flip logo hidden-xs animated fadeIn" src="{{Storage::disk('public')->url('../img/logo-square-colored-radius.png')}}" alt="Logo Icon">
                        @else
